...
- **禁止使用表情符号（Emoji）**：如 😊 ❤️ 🚀 等所有表情符号
- **禁止使用图形符号**：如 📋 🛠️ 📁 等所有装饰性图形符号
- **使用纯文本标记**：使用标准的 Markdown 标记（如 `##`、`-`、`**粗体**`）
- **保持专业风格**：文档应采用专业、简洁的技术文档风格
- **替代方案**：
  - 使用标准的项目符号（`-`、`*`、`[x]`）代替图形符号
  - 使用文字描述代替表情符号（如"重要"、"注意"代替⚠️）
  - 使用标准的标题层级结构代替装饰性符号
...
- **严格禁止使用表情符号和图形符号**：所有文档输出必须保持专业的技术文档风格
- **使用标准 Markdown 语法**：避免使用装饰性元素，保持文档简洁易读
- **专业术语使用**：使用准确的技术术语，避免口语化表达
- **结构清晰**：文档应具有清晰的层级结构，便于阅读和理解
